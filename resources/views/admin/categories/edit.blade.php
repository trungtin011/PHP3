...
<div class="form-wrapper">
    <h2 class="text-xl font-semibold text-center text-gray-800 mb-5">Chỉnh sửa danh mục</h2>
        ...
        <div class="mb-4">
            ...
            <div class="icon-scroll-container">
                ...
                @foreach ($icons as $icon)
                    <div class="icon-box">
                        <i class="fas fa-{{ $icon }} text-blue-500 text-2xl icon-option {{ $category->icon == 'fas fa-' . $icon ? 'selected text-orange-shopee' : '' }}" data-icon="fas fa-{{ $icon }}"></i>
                    </div>
                @endforeach
            </div>
        </div>
