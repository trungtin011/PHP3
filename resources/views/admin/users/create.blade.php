...
<div class="form-wrapper">
    <h2 class="text-xl font-semibold text-center text-gray-800 mb-5">Thêm người dùng</h2>
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-4">
            <label for="password" class="form-label text-sm font-semibold text-gray-700">
                Mật khẩu <span class="text-orange-shopee">*</span>
            </label>
        ...
        <div class="mb-4">
            <label for="password_confirmation" class="form-label text-sm font-semibold text-gray-700">
                Xác nhận mật khẩu <span class="text-orange-shopee">*</span>
            </label>
